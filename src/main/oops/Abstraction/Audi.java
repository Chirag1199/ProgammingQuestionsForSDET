...
public class Audi extends Car {
    ...
    // If Parent has abstract methods including Ferrari Car, Audi class has to
    // invoke the method for ferrari too. Once we extend the class, Car has
    // 2 abstract methods which needs to be called in child class.

    @Override
    public void showFerrariDetails(){
        System.out.println("Inheriting abstract ferrari method from parent class in Audi class. ");
    }
